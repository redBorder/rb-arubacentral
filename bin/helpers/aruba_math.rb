...
module ArubaMathHelper
  def self.move_coordinates_meters(east_movement, north_movement, lat, long)
    corrector_north=2.136
    corrector_east=2.068
    earth_major_radius = 6_378_137.0
    earth_minor_radius = 6_356_752.3
    radians_to_degrees = 180 / Math::PI
    change_lat = (north_movement*corrector_north) / earth_minor_radius * radians_to_degrees
    change_long = (east_movement*corrector_east) / (earth_major_radius * Math.cos(lat / radians_to_degrees)) * radians_to_degrees
